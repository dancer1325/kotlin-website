...
Collection operations are declared in the standard library in two ways: [member functions](docs/topics/concepts/Classes and objects/Classes/classes.md#class-members) of
