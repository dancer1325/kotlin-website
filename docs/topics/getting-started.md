...
* ways
  ...
  * [install Kotlin CL compiler](command-line.md)

## Choose your Kotlin use case

* [Desktop application](jvm/jvm-get-started)
...
* Backend
  ...
  * check 
    ...
    * \+ TP libraries 
      * [adding library and tool dependencies | your project](gradle-configure-project.md#configure-dependencies)
      * [Kotlin standard library](https://kotlinlang.org/api/latest/jvm/stdlib/)
      * [TP frameworks, libs and tools for Kotlin](https://blog.jetbrains.com/kotlin/2020/11/server-side-development-with-kotlin-frameworks-and-libraries/)
    * others
      * [How to write your first unit test](jvm-test-using-junit.md)
      * [How to mix Kotlin and Java code | your application](mixing-java-kotlin-intellij.md)
