...
| [Education](templates/pages/education/index.md) | 

#### Sources | DIFFERENT repositories

| Content                                                                           |
|-----------------------------------------------------------------------------------|
| [Kotlin Coroutines](https://github.com/Kotlin/kotlinx.coroutines/)                |
| [Lincheck docs](https://github.com/Kotlin/kotlinx-lincheck/)                      |
| [Dokka docs](https://github.com/Kotlin/dokka/)                                    | 
| [Library creators' guidelines](https://github.com/Kotlin/api-guidelines)          |
| [Language specification](https://github.com/Kotlin/kotlin-spec)                   | 
| [Kotlin Multiplatform](https://github.com/dancer1325/kotlin-multiplatform-website)|

#### Auto-generated content

* [API reference documentation](https://kotlinlang.org/api/core/kotlin-stdlib/)
  * generated -- , by [Kotlin documentation](/docs/topics/kotlin-doc.md), based on -- Kotlin code's comments
    * [source code](https://github.com/dancer1325/kotlin/blob/master/libraries/stdlib/src/Module.md)

* [Kotlin grammar reference](https://kotlinlang.org/docs/reference/grammar.html) 
  * generated -- by the -- [Kotlin grammar generator](https://github.com/Kotlin/website-grammar-generator)
  * [source code](https://github.com/Kotlin/kotlin-spec/tree/release/grammar/src/main/antlr)
